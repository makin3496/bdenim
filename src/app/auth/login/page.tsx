    ...
    <div className="min-h-screen flex items-center justify-center px-6 pt-[100px] pb-20" style={{ background: "var(--t-bg)" }}>
      <div className="w-full max-w-[420px]">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-sm mt-2" style={{ color: "var(--t-text-muted)" }}>Welcome back</p>
        </div>

        {/* Form Card */}
        <div className="glass-card rounded-xl p-8">
          <h1 className="text-xl font-bold mb-6" style={{ color: "var(--t-text)" }}>Sign In</h1>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                <label className="text-xs font-medium tracking-wider uppercase" style={{ color: "var(--t-text-muted)" }}>Password</label>
                <a href="#" className="text-xs" style={{ color: "var(--t-accent)" }}>Forgot?</a>
              </div>
              <input
                type="password"
                value={password}
          ...
          <p className="text-center text-sm mt-6" style={{ color: "var(--t-text-muted)" }}>
            ...
            <Link href="/auth/register" className="font-medium no-underline" style={{ color: "var(--t-accent)" }}>
              Sign Up
            </Link>
          </p>
        </div>
